    ...
    def post(self,request, *args, **kwargs):
        ...
        if posicion_serializer.is_valid():
            ...
            if posicionlogo == 'derecha':
                if SizeLogo == 'grande':
                    logo.drawImage(logfilecp, 380, 710, 260, 110)
                    logo.save()
                if SizeLogo == 'medio':
                    logo.drawImage(logfilecp, 380, 710, 220, 70)
                    logo.save()
                if SizeLogo == 'peque':
                    logo.drawImage(logfilecp, 380, 710, 180, 40)
                    logo.save()
            elif posicionlogo  == 'izquierda':
                if SizeLogo == 'grande':
                    logo.drawImage(logfilecp, 29, 710, 260, 110)
                    logo.save()
                if SizeLogo == 'medio':
                    logo.drawImage(logfilecp, 29, 710, 220, 70)
                    logo.save()
                if SizeLogo == 'peque':
                    logo.drawImage(logfilecp, 29, 710, 180, 40)
                    logo.save()
